...
;// CONCATENATED MODULE: ./src/components/Ui/Buttons/ButtonBlue.tsx

var ButtonBlue_jsx = (external_react_default()).createElement;



const ButtonBlue = props => {
  return ButtonBlue_jsx(next_link.default, {
    href: props.href ? props.href : '#'
  }, ButtonBlue_jsx("a", {
    className: `${(Buttons_module_default()).ButtonOrange} ${props.className} ${props.type === "outline" ? (Buttons_module_default()).outlinedBlue : props.type === "full" ? (Buttons_module_default()).fullBlue : null}`,
    onClick: props.onClick
  }, props.text));
};

/* harmony default export */ var Buttons_ButtonBlue = (ButtonBlue);
...
const Creditcard = ({
  ...
  }, Creditcard_jsx(Buttons_ButtonBlue, {
    type: "full",
    text: "Ans\xF6k nu!",
