...
const TextHeader = () => {
  ...
  }, __jsx("h1", null, "Vi hj\xE4lper dig att hitta det b\xE4sta kortet f\xF6r just dig...")), __jsx("div", {
...
var DisplayCards = __webpack_require__(3591);
...
const TopCards = ({
  ...
  }, TopCards_jsx("h3", null, "V\xE5ra popul\xE4raste kreditkort"), TopCards_jsx(DisplayCards/* default */.Z, {
    creditCards: cards
  }));
};
...
class IndexPage extends (external_react_default()).Component {
  render() {
    ...
    return pages_jsx("div", null, pages_jsx((head_default()), null, pages_jsx("title", null, "kreditkortskoll.com"), pages_jsx("meta", {
      name: "description",
      ...
      bestcard: bestcard
    }), pages_jsx("main", null, pages_jsx(WhyUs_WhyUs, null), pages_jsx(UpdatedInforamtion_UpdatedInformation, null), pages_jsx(TopCards_TopCards, {
      creditCards: list
    })));
  }
...
var __webpack_exports__ = __webpack_require__.X(0, [75,664,675,467,788], function() { return __webpack_exec__(1163); });
